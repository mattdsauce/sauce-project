...
public class ChromeBetaTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public ChromeBetaTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"Windows 10", "beta", "chrome"});
        return browsers;
    }
