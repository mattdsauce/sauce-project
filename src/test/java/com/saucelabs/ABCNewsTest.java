...
public class ABCNewsTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public ABCNewsTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "ABC News Test: " + browser + " " + version + ", " + os);
     ...
     */
    @Test
    public void abcnews() throws Exception {
        driver.get("http://www.abc.net.au/news");


        Thread.sleep(30000);

        assertTrue(driver.getTitle().startsWith("ABC News"));
    }
