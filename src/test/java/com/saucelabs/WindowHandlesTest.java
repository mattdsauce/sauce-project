...
public class WindowHandlesTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public WindowHandlesTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        //browsers.add(new String[]{"Windows 10", "47", "firefox"});
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Window Handles Test: " + browser + " " + version + ", " + os);
