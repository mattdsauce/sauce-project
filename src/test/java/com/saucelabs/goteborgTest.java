...
public class goteborgTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public goteborgTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "goteborg Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        ...
        WebElement el = driver.findElement(By.xpath("//a[contains(@class, 'navbar__link') and contains(., 'Trafik')]"));
        el.click();
