...
public class AndroidAppContextsTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Android Contexts App Test");
        capabilities.setCapability("app", "http://smt-demofiles.s3.amazonaws.com/mockfiles/APKs/appwithflagworks.apk");
