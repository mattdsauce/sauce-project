 ...
 * @author Ross Rowe
 */
public class iOSAcuvueTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "iOS Acuvue App Test");
        capabilities.setCapability("app","sauce-storage:MyAcuvue-app.zip");
    ...
    public void doTest() throws Exception {
        ...
        WebElement el = driver.findElementByName("Login");
        el.click();

        el = waitForElementByAccessibilityId("Store");
        el.click();
    ...
    public WebElement waitForElementByAccessibilityId(String locator) {
