 ...
 * @author Ross Rowe
 */
public class iOSRDCAppTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("deviceName", "iPhone 6s Plus Device");
        capabilities.setCapability("appiumVersion", "1.5.3");
        capabilities.setCapability("autoAcceptAlerts", "true");
        capabilities.setCapability("name", "iOS RDC App Test");
        capabilities.setCapability("app", "sauce-storage:twopageapp.ipa");
