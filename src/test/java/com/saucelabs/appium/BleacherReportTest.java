...
public class BleacherReportTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "BleacherReport Test");
        capabilities.setCapability("app", "sauce-storage:ts_android_rc.zip");
        capabilities.setCapability("appPackage", "com.bleacherreport.android.teamstream");
        capabilities.setCapability("appActivity", ".TsLaunchActivity");
