...
public class RentpathTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public RentpathTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Rentpath Test: " + browser + " " + version + ", " + os);
    ...
    public void doTest() throws Exception {
        ...
        driver.get("https://www.qa.apartmentguide.com/apartments/Alaska/Yakutat/");
        ...
        WebElement el = driver.findElement(By.cssSelector("[data-tag_section=refinements]"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id='2-beds']"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id=price-menu]"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id='price-500']"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id='price-1500']"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id=search-bar-more]"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id=baths-filter]"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id=two-baths]"));
        el.click();

        el = driver.findElement(By.cssSelector("[data-test-id=update-results-button]"));
        el.click();


        Thread.sleep(5000);

        assertTrue(driver.getTitle().toLowerCase().contains("apartments"));
