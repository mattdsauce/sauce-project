...
public class berlinerTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public berlinerTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"macOS 10.12", "latest-1", "firefox"});
        browsers.add(new String[]{"macOS 10.12", "latest-2", "firefox"});
        browsers.add(new String[]{"macOS 10.12", "latest-3", "firefox"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        //capabilities.setCapability("screenResolution", "2360x1770"); // 2048x1536
        //capabilities.setCapability("extendedDebugging", true);
        //capabilities.setCapability("javascriptEnabled",true);
        //capabilities.setCapability("tunnelIdentifier", "mattTunnel");
        //capabilities.setCapability("seleniumVersion", "3.6.0");
        ...
        capabilities.setCapability("name", "Berliner Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        ...
        driver.get("http://www.berliner-zeitung.de");
        ...
        assertTrue(driver.getTitle().toLowerCase().contains("berliner"));
