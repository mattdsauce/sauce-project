...
public class EdgeTests implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public EdgeTests(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("screenResolution", "1280x1024"); // 2048x1536
        HashMap<String,Object> prerun = new HashMap<String,Object>();
        prerun.put("executable","https://gist.github.com/Wei-Wang-Eva/58d114ab654068589cfed7d9ff352095/raw/853f1b4e44d76b3597fd73ac64e21165f3901dec/enableEdgePopup.bat");
        prerun.put("background",false);
        prerun.put("timeout","120");
        capabilities.setCapability("prerun", prerun);
        capabilities.setCapability("name", "Edge Test: " + browser + " " + version + ", " + os);
