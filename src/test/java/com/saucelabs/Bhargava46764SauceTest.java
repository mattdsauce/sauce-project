...
public class Bhargava46764SauceTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param iosVersion
     */
    public Bhargava46764SauceTest(String device, String iosVersion) {
        super();
        this.device = device;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Bhargava 46764 Test: " + device + " iOS " + iosVersion);
