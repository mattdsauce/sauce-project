...
public class CheggTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public CheggTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Chegg Login Test"); // - iedriverVersion " + ieDriverVer);
    ...
    public void loadPage() throws Exception {
        ...
        driver.get("https://chegg-staging.insidetrack.com/signin");
        ...
        email.clear();
        email.sendKeys("sem185app+877@gmail.com");

        WebElement password = driver.findElement(By.id("password"));
        password.clear();
        password.sendKeys("12345678");

        driver.findElement(By.cssSelector(".btn.btn-main")).click();
