...
public class IE11Test implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public IE11Test(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "IE 11 Test"); // - iedriverVersion " + ieDriverVer);
    ...
    public void loadPage() throws Exception {
        ...
        driver.get("http://charternet:Chart3rn3t@www.engprod-charter.net");
