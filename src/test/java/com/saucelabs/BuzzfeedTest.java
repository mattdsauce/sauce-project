...
public class BuzzfeedTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public BuzzfeedTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"Windows 7", "latest-1", "chrome"});
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Buzzfeed Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        driver.get("https://www.buzzfeed.com/amphtml/ianfeather/a-list-of-useful-subbuzzes-from-ian?e2e_test=1520499804319");

        WebElement el = driver.findElement(By.cssSelector(".analyt-share-subbuzz-facebook"));
        Point location = el.getLocation();
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window.scrollTo(" + location.getX() + "," + location.getY() + ")");

        el = driver.findElement(By.cssSelector(".analyt-share-subbuzz-facebook"));
        el.click();
