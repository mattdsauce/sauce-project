...
public class CustomDataTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public CustomDataTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        //browsers.add(new String[]{"OS X 10.8", "latest", "chrome"});
        //browsers.add(new String[]{"Windows 7", "9.0", "internet explorer"});
        //browsers.add(new String[]{"Windows 7", "45", "firefox"});
        browsers.add(new String[]{"OS X 10.8", "latest", "chrome"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        //capabilities.setCapability("chromedriverVersion", "2.21");
        //capabilities.setCapability("captureHtml",true);
        capabilities.setCapability("name", "Custom Data Test");
        //capabilities.setCapability("build", "testBuild");

        JSONObject obj = new JSONObject();
        obj.put("release", "1.0");
        obj.put("staging", true);
        capabilities.setCapability("customData", obj);
