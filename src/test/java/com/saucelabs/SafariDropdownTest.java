...
public class SafariDropdownTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public SafariDropdownTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"macOS 10.12", "11.0", "safari"});
        browsers.add(new String[]{"macOS 10.13", "11.1", "safari"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Safari Dropdown Test: " + browser + " " + version + ", " + os);
