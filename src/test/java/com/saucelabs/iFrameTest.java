...
public class iFrameTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public iFrameTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"OS X 10.11", "latest", "safari"});
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "iFrame Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        ...
        driver.get("https://mattdsauce.github.io/iframetest.html");

        System.out.println("page URL: " + driver.getCurrentUrl());

        driver.switchTo().frame(0);

        System.out.println("iframe URL: " + driver.getCurrentUrl());
