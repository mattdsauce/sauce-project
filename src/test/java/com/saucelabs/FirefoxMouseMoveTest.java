...
public class FirefoxMouseMoveTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public FirefoxMouseMoveTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"macOS 10.13", "latest", "firefox"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Mouse Move Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        ...
        // move mouse to a random link on the page
