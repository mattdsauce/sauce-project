...
public class JavaAppletTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public JavaAppletTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        //browsers.add(new String[]{"OS X 10.11", "10", "safari"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        prerun.put("executable","sauce-storage:downloadTrustedCerts.bat");
        prerun.put("background",false);
        prerun.put("timeout","120");
        capabilities.setCapability("prerun", prerun);

        capabilities.setCapability("ignoreProtectedModeSettings", true);
        capabilities.setCapability("name", "Java Applet Test: " + browser + " " + version + ", " + os);
    ...
    public void runTest() throws Exception {
        ...
        driver.get("http://www.ssec.wisc.edu/~tomw/version.html");

        System.out.println("After driver.get: " + time_formatter.format(System.currentTimeMillis()));

        Thread.sleep(300000);

        assertTrue(driver.getTitle().startsWith("Get JVM"));
    }
