...
public class IEGetElementsTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public IEGetElementsTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void loadPage() throws Exception {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated((By.id("signinout"))));

        List<WebElement> elems = driver.findElements(By.cssSelector(".unstyled.inline>li>a"));
