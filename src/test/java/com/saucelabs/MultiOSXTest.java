...
public class MultiOSXTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public MultiOSXTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Multi OSX Test");
