...
public class WebRTCLogTest implements SauceOnDemandSessionIdProvider {
    ...
    public void setUp() throws Exception {
        ...
        options.addArguments("user-data-dir=C:\\Chrome", "enable-logging","vmodule=*/webrtc/*=2,*/libjingle/*=2,*=-2", "no-sandbox",
                "start-maximized", "disable-webgl","blacklist-webgl",
        ...
        caps.setCapability("name", "Chrome WebRTC Log Test");
