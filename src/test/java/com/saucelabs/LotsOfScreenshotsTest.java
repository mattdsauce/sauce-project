...
public class LotsOfScreenshotsTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public LotsOfScreenshotsTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Lots of Screenshots Test: " + browser + " " + version + ", " + os);
    ...
    public void loadpage() throws Exception {
        ...
        for (int i = 1; i <= 140; i++) {
            ...
            WebElement shopAllLink = driver.findElement(By.id("nav-link-shopall"));
            shopAllLink.click();
