...
public class TimezoneTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public TimezoneTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void amazon() throws Exception {
        ...
        assertTrue(driver.getTitle().startsWith("What is my time zone?"));
    }
