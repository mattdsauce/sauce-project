...
public class FirefoxTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public FirefoxTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"OS X 10.11", "48", "firefox"});
        //browsers.add(new String[]{"OS X 10.8", "latest", "chrome"});
        return browsers;
    }
